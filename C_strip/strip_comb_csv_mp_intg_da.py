...
data_in = ["da_cfgs_integrated/da_a_src011"]
cfg_file = ["list/list_cfg_a"]
data_out = "da_comb/da_a_src011"
try:
...
def collectdata_integrated(fileline):
    ...
    if 'c2pt' in data_in[0] or 'da' in data_in[0]:
        #normfactor = 0.0637332 #48c64 0.038888
        #normfactor = 0.0635442 #64c64 0.033
        normfactor = 0.0640599 #64c64 0.049
    elif 'c3pt' in data_in[0]:
...
if __name__ == "__main__":
    ...
    if "c2pt" in data_in[0]:
    ...
    elif "da" in data_in[0] and "integrated" in data_in[0]:
        print("Integrated combination of da data.")
        ...
        for ibxp in bxplist:
            for ig in glist:
                ...
                filelist = []
                f_name_part1 = '*.da.SP.meson.ama.' + ibxp
                f_i = []
                for i in range(0, len(data_in)):
                    f_dir_i = data_in[i]+'/*/'+ibxp+'/'
                        ...
                        for iqx in qxlist:
                            for iqy in qylist:
                                for iqz in qzlist:
                                    ...
                                    f_name_part2 = '.'+str(ig)+'.qx'+str(iqx)+'_qy'+str(iqy)+'_qz'+str(iqz)+'.X'+str(iX)
                                    i_f_save = data_out + '/' + f_name_part1.replace('*.','') + f_name_part2
                                    i_f_save = i_f_save.replace(ibxp,ibxp+hyp)
