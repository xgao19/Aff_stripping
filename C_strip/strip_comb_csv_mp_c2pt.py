...
data_in = ["c2pt_cfgs/c2pt_a_src011"]
cfg_file = ["list/list_cfg_a"]
data_out = "c2pt_comb/c2pt_a_src011"
#Nraw = 32
#Ncfg = 206
...
if __name__ == "__main__":
    ...
    if "c2pt" in data_in[0]:
        ...
        smlist = ['SS','SP']
        glist = ['meson_g15']
        pxlist = [ipx for ipx in range(-10, 11)]
        pylist = [-2,-1,0,1,2]
        pzlist = [-2,-1,0,1,2]
        ...
        bxplist = ['bxp00_bxp00','bxp00_bxp00','bxp20_bxp20','bxp20_bxp20','bxp30_bxp30','bxp30_bxp30']
        hyp='_hyp'
        pxlist = [4,5]
        pylist = [0]
        pzlist = [0]
