...
data_in = ["c3pt_cfgs_integrated/c3pt_a3"]
cfg_file = ["list/list.cfg.breit.a3"]
data_out = "c3pt_comb/c3pt_a3"
#Nraw = 32
#Ncfg = 206
...
if __name__ == "__main__":
    ...
    if "c2pt" in data_in[0]:
        ...
        smlist = ['SS','SP']
        glist = ['meson_g15']
        pxlist = [ipx for ipx in range(-9,10)]
        pylist = [-2,-1,0,1,2]
        pzlist = [-2,-1,0,1,2]
        ...
        glist = ['g8']
        #glist = ['g0','g1','g2','g4','g8']
        Xlist = [-i for i in range(-24, 0)] + [i for i in range(-24, 1)]
        qxlist = [-2,-1,0,1,2]
        qylist = [-2,-1,0,1,2]
        qzlist = [-2,-1,0,1,2]
        qxyzlist = [[0,0,2],[0,0,-2],[0,-2,0],[0,2,0]]     
